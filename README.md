...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@placekit/autocomplete-js@1.1.1/dist/placekit-autocomplete.min.css" />
...
```html
<script type="module">
  import placekit from 'https://cdn.jsdelivr.net/npm/@placekit/autocomplete-js@1.1.1/dist/placekit-autocomplete.esm.js';
...
| `noResults` | AutoComplete | `string\|() => string` | [see index.js](./src/index.js#L109-L114) | No result template. |
