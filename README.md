...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@placekit/autocomplete-js@1.0.0-alpha.1/dist/placekit-autocomplete.min.css" />
...
```html
<script type="module">
  import placekit from 'https://cdn.jsdelivr.net/npm/@placekit/autocomplete-js@1.0.0-alpha.1/dist/placekit-autocomplete.esm.js';
